...
func (jc *JobController) SyncPodGroup(job metav1.Object, minAvailableReplicas int32, priorityClassName, queue string) (*v1alpha1.PodGroup, error) {
	...
	if queue != "" {
		createPodGroup.Spec.Queue = queue
	}
